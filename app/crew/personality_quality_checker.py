...
name = "personality_checker"


def get_agent() -> Agent:
    """Retrieve an agent by name"""

    checking_agent = get_base_agent(name, get_agent_prompt())

    return checking_agent


checker_agent = get_agent()
checker_tool = checker_agent.as_tool(tool_name=name, tool_description=get_tool_prompt())

if __name__ == "__main__":
    logger.info("Starting Personality Quality Checker Agent")
